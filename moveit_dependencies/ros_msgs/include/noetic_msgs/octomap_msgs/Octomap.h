...
struct Octomap_
{
  ...
  typedef std::shared_ptr< ::octomap_msgs::Octomap_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::octomap_msgs::Octomap_<ContainerAllocator> const> ConstPtr;

}; // struct Octomap_

typedef ::octomap_msgs::Octomap_<std::allocator<void> > Octomap;

typedef std::shared_ptr< ::octomap_msgs::Octomap > OctomapPtr;
typedef std::shared_ptr< ::octomap_msgs::Octomap const> OctomapConstPtr;
