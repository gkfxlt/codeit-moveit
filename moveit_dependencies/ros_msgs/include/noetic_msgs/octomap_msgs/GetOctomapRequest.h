...
struct GetOctomapRequest_
{
  ...
  typedef std::shared_ptr< ::octomap_msgs::GetOctomapRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::octomap_msgs::GetOctomapRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetOctomapRequest_

typedef ::octomap_msgs::GetOctomapRequest_<std::allocator<void> > GetOctomapRequest;

typedef std::shared_ptr< ::octomap_msgs::GetOctomapRequest > GetOctomapRequestPtr;
typedef std::shared_ptr< ::octomap_msgs::GetOctomapRequest const> GetOctomapRequestConstPtr;
