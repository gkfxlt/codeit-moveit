...
struct OctomapWithPose_
{
  ...
  typedef std::shared_ptr< ::octomap_msgs::OctomapWithPose_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::octomap_msgs::OctomapWithPose_<ContainerAllocator> const> ConstPtr;

}; // struct OctomapWithPose_

typedef ::octomap_msgs::OctomapWithPose_<std::allocator<void> > OctomapWithPose;

typedef std::shared_ptr< ::octomap_msgs::OctomapWithPose > OctomapWithPosePtr;
typedef std::shared_ptr< ::octomap_msgs::OctomapWithPose const> OctomapWithPoseConstPtr;
