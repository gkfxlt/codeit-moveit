...
struct GetOctomapResponse_
{
  ...
  typedef std::shared_ptr< ::octomap_msgs::GetOctomapResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::octomap_msgs::GetOctomapResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetOctomapResponse_

typedef ::octomap_msgs::GetOctomapResponse_<std::allocator<void> > GetOctomapResponse;

typedef std::shared_ptr< ::octomap_msgs::GetOctomapResponse > GetOctomapResponsePtr;
typedef std::shared_ptr< ::octomap_msgs::GetOctomapResponse const> GetOctomapResponseConstPtr;
