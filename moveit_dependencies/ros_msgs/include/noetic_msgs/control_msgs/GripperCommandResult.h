...
struct GripperCommandResult_
{
  ...
  typedef std::shared_ptr< ::control_msgs::GripperCommandResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::GripperCommandResult_<ContainerAllocator> const> ConstPtr;

}; // struct GripperCommandResult_

typedef ::control_msgs::GripperCommandResult_<std::allocator<void> > GripperCommandResult;

typedef std::shared_ptr< ::control_msgs::GripperCommandResult > GripperCommandResultPtr;
typedef std::shared_ptr< ::control_msgs::GripperCommandResult const> GripperCommandResultConstPtr;
