...
struct GripperCommandGoal_
{
  ...
  typedef std::shared_ptr< ::control_msgs::GripperCommandGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::GripperCommandGoal_<ContainerAllocator> const> ConstPtr;

}; // struct GripperCommandGoal_

typedef ::control_msgs::GripperCommandGoal_<std::allocator<void> > GripperCommandGoal;

typedef std::shared_ptr< ::control_msgs::GripperCommandGoal > GripperCommandGoalPtr;
typedef std::shared_ptr< ::control_msgs::GripperCommandGoal const> GripperCommandGoalConstPtr;
