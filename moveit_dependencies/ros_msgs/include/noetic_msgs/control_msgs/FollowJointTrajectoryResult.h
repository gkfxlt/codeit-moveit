...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryResult_<ContainerAllocator> const> ConstPtr;

}; // struct FollowJointTrajectoryResult_

typedef ::control_msgs::FollowJointTrajectoryResult_<std::allocator<void> > FollowJointTrajectoryResult;

typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryResult > FollowJointTrajectoryResultPtr;
typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryResult const> FollowJointTrajectoryResultConstPtr;
