...
struct JointTolerance_
{
  ...
  typedef std::shared_ptr< ::control_msgs::JointTolerance_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::JointTolerance_<ContainerAllocator> const> ConstPtr;

}; // struct JointTolerance_

typedef ::control_msgs::JointTolerance_<std::allocator<void> > JointTolerance;

typedef std::shared_ptr< ::control_msgs::JointTolerance > JointTolerancePtr;
typedef std::shared_ptr< ::control_msgs::JointTolerance const> JointToleranceConstPtr;
