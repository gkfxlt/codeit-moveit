...
struct FollowJointTrajectoryFeedback_
{
  ...
  typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryFeedback_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct FollowJointTrajectoryFeedback_

typedef ::control_msgs::FollowJointTrajectoryFeedback_<std::allocator<void> > FollowJointTrajectoryFeedback;

typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryFeedback > FollowJointTrajectoryFeedbackPtr;
typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryFeedback const> FollowJointTrajectoryFeedbackConstPtr;
