...
struct FollowJointTrajectoryActionGoal_
{
  ...
  typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct FollowJointTrajectoryActionGoal_

typedef ::control_msgs::FollowJointTrajectoryActionGoal_<std::allocator<void> > FollowJointTrajectoryActionGoal;

typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryActionGoal > FollowJointTrajectoryActionGoalPtr;
typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryActionGoal const> FollowJointTrajectoryActionGoalConstPtr;
