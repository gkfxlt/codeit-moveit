...
struct GripperCommandAction_
{
  ...
  typedef std::shared_ptr< ::control_msgs::GripperCommandAction_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::GripperCommandAction_<ContainerAllocator> const> ConstPtr;

}; // struct GripperCommandAction_

typedef ::control_msgs::GripperCommandAction_<std::allocator<void> > GripperCommandAction;

typedef std::shared_ptr< ::control_msgs::GripperCommandAction > GripperCommandActionPtr;
typedef std::shared_ptr< ::control_msgs::GripperCommandAction const> GripperCommandActionConstPtr;
