...
struct GripperCommand_
{
  ...
  typedef std::shared_ptr< ::control_msgs::GripperCommand_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::GripperCommand_<ContainerAllocator> const> ConstPtr;

}; // struct GripperCommand_

typedef ::control_msgs::GripperCommand_<std::allocator<void> > GripperCommand;

typedef std::shared_ptr< ::control_msgs::GripperCommand > GripperCommandPtr;
typedef std::shared_ptr< ::control_msgs::GripperCommand const> GripperCommandConstPtr;
