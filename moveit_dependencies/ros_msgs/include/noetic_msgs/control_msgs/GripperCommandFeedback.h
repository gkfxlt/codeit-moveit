...
struct GripperCommandFeedback_
{
  ...
  typedef std::shared_ptr< ::control_msgs::GripperCommandFeedback_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::GripperCommandFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct GripperCommandFeedback_

typedef ::control_msgs::GripperCommandFeedback_<std::allocator<void> > GripperCommandFeedback;

typedef std::shared_ptr< ::control_msgs::GripperCommandFeedback > GripperCommandFeedbackPtr;
typedef std::shared_ptr< ::control_msgs::GripperCommandFeedback const> GripperCommandFeedbackConstPtr;
