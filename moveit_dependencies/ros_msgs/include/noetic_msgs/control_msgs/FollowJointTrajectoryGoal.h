...
struct FollowJointTrajectoryGoal_
{
  ...
  typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryGoal_<ContainerAllocator> const> ConstPtr;

}; // struct FollowJointTrajectoryGoal_

typedef ::control_msgs::FollowJointTrajectoryGoal_<std::allocator<void> > FollowJointTrajectoryGoal;

typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryGoal > FollowJointTrajectoryGoalPtr;
typedef std::shared_ptr< ::control_msgs::FollowJointTrajectoryGoal const> FollowJointTrajectoryGoalConstPtr;
