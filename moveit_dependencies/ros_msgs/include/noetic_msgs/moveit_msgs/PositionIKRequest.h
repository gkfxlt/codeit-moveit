...
struct PositionIKRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PositionIKRequest_<ContainerAllocator> const> ConstPtr;

}; // struct PositionIKRequest_

typedef ::moveit_msgs::PositionIKRequest_<std::allocator<void> > PositionIKRequest;

typedef std::shared_ptr< ::moveit_msgs::PositionIKRequest > PositionIKRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::PositionIKRequest const> PositionIKRequestConstPtr;
