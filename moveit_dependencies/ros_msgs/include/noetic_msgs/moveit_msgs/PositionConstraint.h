...
struct PositionConstraint_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PositionConstraint_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PositionConstraint_<ContainerAllocator> const> ConstPtr;

}; // struct PositionConstraint_

typedef ::moveit_msgs::PositionConstraint_<std::allocator<void> > PositionConstraint;

typedef std::shared_ptr< ::moveit_msgs::PositionConstraint > PositionConstraintPtr;
typedef std::shared_ptr< ::moveit_msgs::PositionConstraint const> PositionConstraintConstPtr;
