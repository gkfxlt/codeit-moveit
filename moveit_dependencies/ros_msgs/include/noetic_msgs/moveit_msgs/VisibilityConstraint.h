...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::moveit_msgs::VisibilityConstraint_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::VisibilityConstraint_<ContainerAllocator> const> ConstPtr;

}; // struct VisibilityConstraint_

typedef ::moveit_msgs::VisibilityConstraint_<std::allocator<void> > VisibilityConstraint;

typedef std::shared_ptr< ::moveit_msgs::VisibilityConstraint > VisibilityConstraintPtr;
typedef std::shared_ptr< ::moveit_msgs::VisibilityConstraint const> VisibilityConstraintConstPtr;
