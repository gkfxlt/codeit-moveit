...
struct GraspPlanningRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GraspPlanningRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GraspPlanningRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GraspPlanningRequest_

typedef ::moveit_msgs::GraspPlanningRequest_<std::allocator<void> > GraspPlanningRequest;

typedef std::shared_ptr< ::moveit_msgs::GraspPlanningRequest > GraspPlanningRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GraspPlanningRequest const> GraspPlanningRequestConstPtr;
