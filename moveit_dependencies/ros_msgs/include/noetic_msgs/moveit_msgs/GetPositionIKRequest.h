...
struct GetPositionIKRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetPositionIKRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetPositionIKRequest_

typedef ::moveit_msgs::GetPositionIKRequest_<std::allocator<void> > GetPositionIKRequest;

typedef std::shared_ptr< ::moveit_msgs::GetPositionIKRequest > GetPositionIKRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetPositionIKRequest const> GetPositionIKRequestConstPtr;
