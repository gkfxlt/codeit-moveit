...
struct MoveGroupSequenceActionGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupSequenceActionGoal_

typedef ::moveit_msgs::MoveGroupSequenceActionGoal_<std::allocator<void> > MoveGroupSequenceActionGoal;

typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceActionGoal > MoveGroupSequenceActionGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceActionGoal const> MoveGroupSequenceActionGoalConstPtr;
