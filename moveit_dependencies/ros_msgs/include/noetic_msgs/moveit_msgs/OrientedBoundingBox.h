...
struct OrientedBoundingBox_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::OrientedBoundingBox_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::OrientedBoundingBox_<ContainerAllocator> const> ConstPtr;

}; // struct OrientedBoundingBox_

typedef ::moveit_msgs::OrientedBoundingBox_<std::allocator<void> > OrientedBoundingBox;

typedef std::shared_ptr< ::moveit_msgs::OrientedBoundingBox > OrientedBoundingBoxPtr;
typedef std::shared_ptr< ::moveit_msgs::OrientedBoundingBox const> OrientedBoundingBoxConstPtr;
