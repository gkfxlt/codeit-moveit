...
struct PlaceLocation_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlaceLocation_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlaceLocation_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceLocation_

typedef ::moveit_msgs::PlaceLocation_<std::allocator<void> > PlaceLocation;

typedef std::shared_ptr< ::moveit_msgs::PlaceLocation > PlaceLocationPtr;
typedef std::shared_ptr< ::moveit_msgs::PlaceLocation const> PlaceLocationConstPtr;
