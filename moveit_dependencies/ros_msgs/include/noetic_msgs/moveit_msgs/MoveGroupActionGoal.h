...
struct MoveGroupActionGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupActionGoal_

typedef ::moveit_msgs::MoveGroupActionGoal_<std::allocator<void> > MoveGroupActionGoal;

typedef std::shared_ptr< ::moveit_msgs::MoveGroupActionGoal > MoveGroupActionGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::MoveGroupActionGoal const> MoveGroupActionGoalConstPtr;
