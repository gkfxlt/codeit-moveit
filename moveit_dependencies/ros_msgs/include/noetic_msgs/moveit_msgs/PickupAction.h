...
struct PickupAction_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PickupAction_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PickupAction_<ContainerAllocator> const> ConstPtr;

}; // struct PickupAction_

typedef ::moveit_msgs::PickupAction_<std::allocator<void> > PickupAction;

typedef std::shared_ptr< ::moveit_msgs::PickupAction > PickupActionPtr;
typedef std::shared_ptr< ::moveit_msgs::PickupAction const> PickupActionConstPtr;
