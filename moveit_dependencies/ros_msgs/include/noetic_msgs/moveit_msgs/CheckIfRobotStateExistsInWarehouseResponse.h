...
struct CheckIfRobotStateExistsInWarehouseResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::CheckIfRobotStateExistsInWarehouseResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::CheckIfRobotStateExistsInWarehouseResponse_<ContainerAllocator> const> ConstPtr;
...
typedef std::shared_ptr< ::moveit_msgs::CheckIfRobotStateExistsInWarehouseResponse > CheckIfRobotStateExistsInWarehouseResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::CheckIfRobotStateExistsInWarehouseResponse const> CheckIfRobotStateExistsInWarehouseResponseConstPtr;
