...
struct GetRobotStateFromWarehouseRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetRobotStateFromWarehouseRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetRobotStateFromWarehouseRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetRobotStateFromWarehouseRequest_

typedef ::moveit_msgs::GetRobotStateFromWarehouseRequest_<std::allocator<void> > GetRobotStateFromWarehouseRequest;

typedef std::shared_ptr< ::moveit_msgs::GetRobotStateFromWarehouseRequest > GetRobotStateFromWarehouseRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetRobotStateFromWarehouseRequest const> GetRobotStateFromWarehouseRequestConstPtr;
