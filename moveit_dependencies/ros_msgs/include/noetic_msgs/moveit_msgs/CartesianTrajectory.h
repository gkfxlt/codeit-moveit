...
struct CartesianTrajectory_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::CartesianTrajectory_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::CartesianTrajectory_<ContainerAllocator> const> ConstPtr;

}; // struct CartesianTrajectory_

typedef ::moveit_msgs::CartesianTrajectory_<std::allocator<void> > CartesianTrajectory;

typedef std::shared_ptr< ::moveit_msgs::CartesianTrajectory > CartesianTrajectoryPtr;
typedef std::shared_ptr< ::moveit_msgs::CartesianTrajectory const> CartesianTrajectoryConstPtr;
