...
struct PlaceResult_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlaceResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlaceResult_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceResult_

typedef ::moveit_msgs::PlaceResult_<std::allocator<void> > PlaceResult;

typedef std::shared_ptr< ::moveit_msgs::PlaceResult > PlaceResultPtr;
typedef std::shared_ptr< ::moveit_msgs::PlaceResult const> PlaceResultConstPtr;
