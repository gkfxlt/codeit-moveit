...
struct RenameRobotStateInWarehouseResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::RenameRobotStateInWarehouseResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::RenameRobotStateInWarehouseResponse_<ContainerAllocator> const> ConstPtr;

}; // struct RenameRobotStateInWarehouseResponse_

typedef ::moveit_msgs::RenameRobotStateInWarehouseResponse_<std::allocator<void> > RenameRobotStateInWarehouseResponse;

typedef std::shared_ptr< ::moveit_msgs::RenameRobotStateInWarehouseResponse > RenameRobotStateInWarehouseResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::RenameRobotStateInWarehouseResponse const> RenameRobotStateInWarehouseResponseConstPtr;
