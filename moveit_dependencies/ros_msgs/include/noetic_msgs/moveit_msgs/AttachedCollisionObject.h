...
struct AttachedCollisionObject_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::AttachedCollisionObject_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::AttachedCollisionObject_<ContainerAllocator> const> ConstPtr;

}; // struct AttachedCollisionObject_

typedef ::moveit_msgs::AttachedCollisionObject_<std::allocator<void> > AttachedCollisionObject;

typedef std::shared_ptr< ::moveit_msgs::AttachedCollisionObject > AttachedCollisionObjectPtr;
typedef std::shared_ptr< ::moveit_msgs::AttachedCollisionObject const> AttachedCollisionObjectConstPtr;
