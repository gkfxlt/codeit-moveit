...
struct RobotTrajectory_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::RobotTrajectory_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::RobotTrajectory_<ContainerAllocator> const> ConstPtr;

}; // struct RobotTrajectory_

typedef ::moveit_msgs::RobotTrajectory_<std::allocator<void> > RobotTrajectory;

typedef std::shared_ptr< ::moveit_msgs::RobotTrajectory > RobotTrajectoryPtr;
typedef std::shared_ptr< ::moveit_msgs::RobotTrajectory const> RobotTrajectoryConstPtr;
