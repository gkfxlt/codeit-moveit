...
struct MotionSequenceItem_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> const> ConstPtr;

}; // struct MotionSequenceItem_

typedef ::moveit_msgs::MotionSequenceItem_<std::allocator<void> > MotionSequenceItem;

typedef std::shared_ptr< ::moveit_msgs::MotionSequenceItem > MotionSequenceItemPtr;
typedef std::shared_ptr< ::moveit_msgs::MotionSequenceItem const> MotionSequenceItemConstPtr;
