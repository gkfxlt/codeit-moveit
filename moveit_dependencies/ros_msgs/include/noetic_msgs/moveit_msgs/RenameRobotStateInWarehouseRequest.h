...
struct RenameRobotStateInWarehouseRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::RenameRobotStateInWarehouseRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::RenameRobotStateInWarehouseRequest_<ContainerAllocator> const> ConstPtr;

}; // struct RenameRobotStateInWarehouseRequest_

typedef ::moveit_msgs::RenameRobotStateInWarehouseRequest_<std::allocator<void> > RenameRobotStateInWarehouseRequest;

typedef std::shared_ptr< ::moveit_msgs::RenameRobotStateInWarehouseRequest > RenameRobotStateInWarehouseRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::RenameRobotStateInWarehouseRequest const> RenameRobotStateInWarehouseRequestConstPtr;
