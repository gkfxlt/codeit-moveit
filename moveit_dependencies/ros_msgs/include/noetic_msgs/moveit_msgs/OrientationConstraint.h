...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::moveit_msgs::OrientationConstraint_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::OrientationConstraint_<ContainerAllocator> const> ConstPtr;

}; // struct OrientationConstraint_

typedef ::moveit_msgs::OrientationConstraint_<std::allocator<void> > OrientationConstraint;

typedef std::shared_ptr< ::moveit_msgs::OrientationConstraint > OrientationConstraintPtr;
typedef std::shared_ptr< ::moveit_msgs::OrientationConstraint const> OrientationConstraintConstPtr;
