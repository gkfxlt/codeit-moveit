...
struct GetPositionFKRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetPositionFKRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetPositionFKRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetPositionFKRequest_

typedef ::moveit_msgs::GetPositionFKRequest_<std::allocator<void> > GetPositionFKRequest;

typedef std::shared_ptr< ::moveit_msgs::GetPositionFKRequest > GetPositionFKRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetPositionFKRequest const> GetPositionFKRequestConstPtr;
