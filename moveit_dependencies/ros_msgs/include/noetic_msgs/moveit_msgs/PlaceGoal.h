...
struct PlaceGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlaceGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlaceGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceGoal_

typedef ::moveit_msgs::PlaceGoal_<std::allocator<void> > PlaceGoal;

typedef std::shared_ptr< ::moveit_msgs::PlaceGoal > PlaceGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::PlaceGoal const> PlaceGoalConstPtr;
