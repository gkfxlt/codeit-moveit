...
struct SaveRobotStateToWarehouseRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::SaveRobotStateToWarehouseRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::SaveRobotStateToWarehouseRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SaveRobotStateToWarehouseRequest_

typedef ::moveit_msgs::SaveRobotStateToWarehouseRequest_<std::allocator<void> > SaveRobotStateToWarehouseRequest;

typedef std::shared_ptr< ::moveit_msgs::SaveRobotStateToWarehouseRequest > SaveRobotStateToWarehouseRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::SaveRobotStateToWarehouseRequest const> SaveRobotStateToWarehouseRequestConstPtr;
