...
struct QueryPlannerInterfacesResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::QueryPlannerInterfacesResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::QueryPlannerInterfacesResponse_<ContainerAllocator> const> ConstPtr;

}; // struct QueryPlannerInterfacesResponse_

typedef ::moveit_msgs::QueryPlannerInterfacesResponse_<std::allocator<void> > QueryPlannerInterfacesResponse;

typedef std::shared_ptr< ::moveit_msgs::QueryPlannerInterfacesResponse > QueryPlannerInterfacesResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::QueryPlannerInterfacesResponse const> QueryPlannerInterfacesResponseConstPtr;
