...
struct PickupFeedback_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PickupFeedback_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PickupFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct PickupFeedback_

typedef ::moveit_msgs::PickupFeedback_<std::allocator<void> > PickupFeedback;

typedef std::shared_ptr< ::moveit_msgs::PickupFeedback > PickupFeedbackPtr;
typedef std::shared_ptr< ::moveit_msgs::PickupFeedback const> PickupFeedbackConstPtr;
