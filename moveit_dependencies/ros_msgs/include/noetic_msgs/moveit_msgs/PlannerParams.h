...
struct PlannerParams_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlannerParams_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlannerParams_<ContainerAllocator> const> ConstPtr;

}; // struct PlannerParams_

typedef ::moveit_msgs::PlannerParams_<std::allocator<void> > PlannerParams;

typedef std::shared_ptr< ::moveit_msgs::PlannerParams > PlannerParamsPtr;
typedef std::shared_ptr< ::moveit_msgs::PlannerParams const> PlannerParamsConstPtr;
