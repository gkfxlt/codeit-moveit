...
struct GetPlannerParamsRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetPlannerParamsRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetPlannerParamsRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetPlannerParamsRequest_

typedef ::moveit_msgs::GetPlannerParamsRequest_<std::allocator<void> > GetPlannerParamsRequest;

typedef std::shared_ptr< ::moveit_msgs::GetPlannerParamsRequest > GetPlannerParamsRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetPlannerParamsRequest const> GetPlannerParamsRequestConstPtr;
