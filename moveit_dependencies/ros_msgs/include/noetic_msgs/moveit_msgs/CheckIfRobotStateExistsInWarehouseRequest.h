...
struct CheckIfRobotStateExistsInWarehouseRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::CheckIfRobotStateExistsInWarehouseRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::CheckIfRobotStateExistsInWarehouseRequest_<ContainerAllocator> const> ConstPtr;
...
typedef std::shared_ptr< ::moveit_msgs::CheckIfRobotStateExistsInWarehouseRequest > CheckIfRobotStateExistsInWarehouseRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::CheckIfRobotStateExistsInWarehouseRequest const> CheckIfRobotStateExistsInWarehouseRequestConstPtr;
