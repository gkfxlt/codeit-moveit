...
struct MoveGroupSequenceAction_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceAction_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupSequenceAction_

typedef ::moveit_msgs::MoveGroupSequenceAction_<std::allocator<void> > MoveGroupSequenceAction;

typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceAction > MoveGroupSequenceActionPtr;
typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceAction const> MoveGroupSequenceActionConstPtr;
