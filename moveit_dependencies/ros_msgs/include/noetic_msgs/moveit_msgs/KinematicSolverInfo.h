...
struct KinematicSolverInfo_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::KinematicSolverInfo_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::KinematicSolverInfo_<ContainerAllocator> const> ConstPtr;

}; // struct KinematicSolverInfo_

typedef ::moveit_msgs::KinematicSolverInfo_<std::allocator<void> > KinematicSolverInfo;

typedef std::shared_ptr< ::moveit_msgs::KinematicSolverInfo > KinematicSolverInfoPtr;
typedef std::shared_ptr< ::moveit_msgs::KinematicSolverInfo const> KinematicSolverInfoConstPtr;
