...
struct Grasp_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::Grasp_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::Grasp_<ContainerAllocator> const> ConstPtr;

}; // struct Grasp_

typedef ::moveit_msgs::Grasp_<std::allocator<void> > Grasp;

typedef std::shared_ptr< ::moveit_msgs::Grasp > GraspPtr;
typedef std::shared_ptr< ::moveit_msgs::Grasp const> GraspConstPtr;
