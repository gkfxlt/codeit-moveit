...
struct PlaceAction_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlaceAction_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlaceAction_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceAction_

typedef ::moveit_msgs::PlaceAction_<std::allocator<void> > PlaceAction;

typedef std::shared_ptr< ::moveit_msgs::PlaceAction > PlaceActionPtr;
typedef std::shared_ptr< ::moveit_msgs::PlaceAction const> PlaceActionConstPtr;
