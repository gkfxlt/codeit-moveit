...
struct MoveGroupActionFeedback_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupActionFeedback_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupActionFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupActionFeedback_

typedef ::moveit_msgs::MoveGroupActionFeedback_<std::allocator<void> > MoveGroupActionFeedback;

typedef std::shared_ptr< ::moveit_msgs::MoveGroupActionFeedback > MoveGroupActionFeedbackPtr;
typedef std::shared_ptr< ::moveit_msgs::MoveGroupActionFeedback const> MoveGroupActionFeedbackConstPtr;
