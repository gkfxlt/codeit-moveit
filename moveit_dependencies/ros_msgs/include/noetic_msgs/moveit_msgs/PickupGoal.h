...
struct PickupGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PickupGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PickupGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PickupGoal_

typedef ::moveit_msgs::PickupGoal_<std::allocator<void> > PickupGoal;

typedef std::shared_ptr< ::moveit_msgs::PickupGoal > PickupGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::PickupGoal const> PickupGoalConstPtr;
