...
struct WorkspaceParameters_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::WorkspaceParameters_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::WorkspaceParameters_<ContainerAllocator> const> ConstPtr;

}; // struct WorkspaceParameters_

typedef ::moveit_msgs::WorkspaceParameters_<std::allocator<void> > WorkspaceParameters;

typedef std::shared_ptr< ::moveit_msgs::WorkspaceParameters > WorkspaceParametersPtr;
typedef std::shared_ptr< ::moveit_msgs::WorkspaceParameters const> WorkspaceParametersConstPtr;
