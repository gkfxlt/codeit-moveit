...
struct PlanningOptions_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlanningOptions_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlanningOptions_<ContainerAllocator> const> ConstPtr;

}; // struct PlanningOptions_

typedef ::moveit_msgs::PlanningOptions_<std::allocator<void> > PlanningOptions;

typedef std::shared_ptr< ::moveit_msgs::PlanningOptions > PlanningOptionsPtr;
typedef std::shared_ptr< ::moveit_msgs::PlanningOptions const> PlanningOptionsConstPtr;
