...
struct GenericTrajectory_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GenericTrajectory_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GenericTrajectory_<ContainerAllocator> const> ConstPtr;

}; // struct GenericTrajectory_

typedef ::moveit_msgs::GenericTrajectory_<std::allocator<void> > GenericTrajectory;

typedef std::shared_ptr< ::moveit_msgs::GenericTrajectory > GenericTrajectoryPtr;
typedef std::shared_ptr< ::moveit_msgs::GenericTrajectory const> GenericTrajectoryConstPtr;
