...
struct ChangeControlDimensionsRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ChangeControlDimensionsRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ChangeControlDimensionsRequest_<ContainerAllocator> const> ConstPtr;

}; // struct ChangeControlDimensionsRequest_

typedef ::moveit_msgs::ChangeControlDimensionsRequest_<std::allocator<void> > ChangeControlDimensionsRequest;

typedef std::shared_ptr< ::moveit_msgs::ChangeControlDimensionsRequest > ChangeControlDimensionsRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::ChangeControlDimensionsRequest const> ChangeControlDimensionsRequestConstPtr;
