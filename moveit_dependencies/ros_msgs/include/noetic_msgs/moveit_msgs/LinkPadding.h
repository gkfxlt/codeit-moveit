...
struct LinkPadding_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::LinkPadding_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::LinkPadding_<ContainerAllocator> const> ConstPtr;

}; // struct LinkPadding_

typedef ::moveit_msgs::LinkPadding_<std::allocator<void> > LinkPadding;

typedef std::shared_ptr< ::moveit_msgs::LinkPadding > LinkPaddingPtr;
typedef std::shared_ptr< ::moveit_msgs::LinkPadding const> LinkPaddingConstPtr;
