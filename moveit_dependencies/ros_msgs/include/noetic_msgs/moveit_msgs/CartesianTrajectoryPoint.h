...
struct CartesianTrajectoryPoint_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::CartesianTrajectoryPoint_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::CartesianTrajectoryPoint_<ContainerAllocator> const> ConstPtr;

}; // struct CartesianTrajectoryPoint_

typedef ::moveit_msgs::CartesianTrajectoryPoint_<std::allocator<void> > CartesianTrajectoryPoint;

typedef std::shared_ptr< ::moveit_msgs::CartesianTrajectoryPoint > CartesianTrajectoryPointPtr;
typedef std::shared_ptr< ::moveit_msgs::CartesianTrajectoryPoint const> CartesianTrajectoryPointConstPtr;
