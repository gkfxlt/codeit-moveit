...
struct PickupActionResult_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PickupActionResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PickupActionResult_<ContainerAllocator> const> ConstPtr;

}; // struct PickupActionResult_

typedef ::moveit_msgs::PickupActionResult_<std::allocator<void> > PickupActionResult;

typedef std::shared_ptr< ::moveit_msgs::PickupActionResult > PickupActionResultPtr;
typedef std::shared_ptr< ::moveit_msgs::PickupActionResult const> PickupActionResultConstPtr;
