...
struct ExecuteTrajectoryFeedback_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryFeedback_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct ExecuteTrajectoryFeedback_

typedef ::moveit_msgs::ExecuteTrajectoryFeedback_<std::allocator<void> > ExecuteTrajectoryFeedback;

typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryFeedback > ExecuteTrajectoryFeedbackPtr;
typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryFeedback const> ExecuteTrajectoryFeedbackConstPtr;
