...
struct MoveGroupGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupGoal_

typedef ::moveit_msgs::MoveGroupGoal_<std::allocator<void> > MoveGroupGoal;

typedef std::shared_ptr< ::moveit_msgs::MoveGroupGoal > MoveGroupGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::MoveGroupGoal const> MoveGroupGoalConstPtr;
