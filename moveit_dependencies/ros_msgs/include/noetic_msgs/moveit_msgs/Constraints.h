...
struct Constraints_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::Constraints_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::Constraints_<ContainerAllocator> const> ConstPtr;

}; // struct Constraints_

typedef ::moveit_msgs::Constraints_<std::allocator<void> > Constraints;

typedef std::shared_ptr< ::moveit_msgs::Constraints > ConstraintsPtr;
typedef std::shared_ptr< ::moveit_msgs::Constraints const> ConstraintsConstPtr;
