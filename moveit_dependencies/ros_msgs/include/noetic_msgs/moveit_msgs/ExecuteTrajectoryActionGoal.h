...
struct ExecuteTrajectoryActionGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct ExecuteTrajectoryActionGoal_

typedef ::moveit_msgs::ExecuteTrajectoryActionGoal_<std::allocator<void> > ExecuteTrajectoryActionGoal;

typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryActionGoal > ExecuteTrajectoryActionGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryActionGoal const> ExecuteTrajectoryActionGoalConstPtr;
