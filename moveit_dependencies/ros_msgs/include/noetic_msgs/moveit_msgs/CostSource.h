...
struct CostSource_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::CostSource_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::CostSource_<ContainerAllocator> const> ConstPtr;

}; // struct CostSource_

typedef ::moveit_msgs::CostSource_<std::allocator<void> > CostSource;

typedef std::shared_ptr< ::moveit_msgs::CostSource > CostSourcePtr;
typedef std::shared_ptr< ::moveit_msgs::CostSource const> CostSourceConstPtr;
