...
struct PickupResult_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PickupResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PickupResult_<ContainerAllocator> const> ConstPtr;

}; // struct PickupResult_

typedef ::moveit_msgs::PickupResult_<std::allocator<void> > PickupResult;

typedef std::shared_ptr< ::moveit_msgs::PickupResult > PickupResultPtr;
typedef std::shared_ptr< ::moveit_msgs::PickupResult const> PickupResultConstPtr;
