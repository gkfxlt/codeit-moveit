...
struct GetCartesianPathRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetCartesianPathRequest_

typedef ::moveit_msgs::GetCartesianPathRequest_<std::allocator<void> > GetCartesianPathRequest;

typedef std::shared_ptr< ::moveit_msgs::GetCartesianPathRequest > GetCartesianPathRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetCartesianPathRequest const> GetCartesianPathRequestConstPtr;
