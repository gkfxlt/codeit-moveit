...
struct PickupActionGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PickupActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PickupActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PickupActionGoal_

typedef ::moveit_msgs::PickupActionGoal_<std::allocator<void> > PickupActionGoal;

typedef std::shared_ptr< ::moveit_msgs::PickupActionGoal > PickupActionGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::PickupActionGoal const> PickupActionGoalConstPtr;
