...
struct SaveMapResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::SaveMapResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::SaveMapResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SaveMapResponse_

typedef ::moveit_msgs::SaveMapResponse_<std::allocator<void> > SaveMapResponse;

typedef std::shared_ptr< ::moveit_msgs::SaveMapResponse > SaveMapResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::SaveMapResponse const> SaveMapResponseConstPtr;
