...
struct MoveGroupSequenceGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupSequenceGoal_

typedef ::moveit_msgs::MoveGroupSequenceGoal_<std::allocator<void> > MoveGroupSequenceGoal;

typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceGoal > MoveGroupSequenceGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::MoveGroupSequenceGoal const> MoveGroupSequenceGoalConstPtr;
