...
struct ChangeDriftDimensionsResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ChangeDriftDimensionsResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ChangeDriftDimensionsResponse_<ContainerAllocator> const> ConstPtr;

}; // struct ChangeDriftDimensionsResponse_

typedef ::moveit_msgs::ChangeDriftDimensionsResponse_<std::allocator<void> > ChangeDriftDimensionsResponse;

typedef std::shared_ptr< ::moveit_msgs::ChangeDriftDimensionsResponse > ChangeDriftDimensionsResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::ChangeDriftDimensionsResponse const> ChangeDriftDimensionsResponseConstPtr;
