...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::moveit_msgs::CollisionObject_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::CollisionObject_<ContainerAllocator> const> ConstPtr;
...
typedef std::shared_ptr< ::moveit_msgs::CollisionObject const> CollisionObjectConstPtr;
