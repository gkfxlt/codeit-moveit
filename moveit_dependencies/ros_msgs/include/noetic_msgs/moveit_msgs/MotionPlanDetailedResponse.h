...
struct MotionPlanDetailedResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MotionPlanDetailedResponse_<ContainerAllocator> const> ConstPtr;

}; // struct MotionPlanDetailedResponse_

typedef ::moveit_msgs::MotionPlanDetailedResponse_<std::allocator<void> > MotionPlanDetailedResponse;

typedef std::shared_ptr< ::moveit_msgs::MotionPlanDetailedResponse > MotionPlanDetailedResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::MotionPlanDetailedResponse const> MotionPlanDetailedResponseConstPtr;
