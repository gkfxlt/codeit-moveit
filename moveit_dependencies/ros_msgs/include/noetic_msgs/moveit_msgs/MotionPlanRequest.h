...
struct MotionPlanRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MotionPlanRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MotionPlanRequest_<ContainerAllocator> const> ConstPtr;

}; // struct MotionPlanRequest_

typedef ::moveit_msgs::MotionPlanRequest_<std::allocator<void> > MotionPlanRequest;

typedef std::shared_ptr< ::moveit_msgs::MotionPlanRequest > MotionPlanRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::MotionPlanRequest const> MotionPlanRequestConstPtr;
