...
struct PlanningScene_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlanningScene_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlanningScene_<ContainerAllocator> const> ConstPtr;

}; // struct PlanningScene_

typedef ::moveit_msgs::PlanningScene_<std::allocator<void> > PlanningScene;

typedef std::shared_ptr< ::moveit_msgs::PlanningScene > PlanningScenePtr;
typedef std::shared_ptr< ::moveit_msgs::PlanningScene const> PlanningSceneConstPtr;
