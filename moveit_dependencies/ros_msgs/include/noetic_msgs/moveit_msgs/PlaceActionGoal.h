...
struct PlaceActionGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlaceActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceActionGoal_

typedef ::moveit_msgs::PlaceActionGoal_<std::allocator<void> > PlaceActionGoal;

typedef std::shared_ptr< ::moveit_msgs::PlaceActionGoal > PlaceActionGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::PlaceActionGoal const> PlaceActionGoalConstPtr;
