...
struct DeleteRobotStateFromWarehouseResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::DeleteRobotStateFromWarehouseResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::DeleteRobotStateFromWarehouseResponse_<ContainerAllocator> const> ConstPtr;

}; // struct DeleteRobotStateFromWarehouseResponse_

typedef ::moveit_msgs::DeleteRobotStateFromWarehouseResponse_<std::allocator<void> > DeleteRobotStateFromWarehouseResponse;

typedef std::shared_ptr< ::moveit_msgs::DeleteRobotStateFromWarehouseResponse > DeleteRobotStateFromWarehouseResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::DeleteRobotStateFromWarehouseResponse const> DeleteRobotStateFromWarehouseResponseConstPtr;
