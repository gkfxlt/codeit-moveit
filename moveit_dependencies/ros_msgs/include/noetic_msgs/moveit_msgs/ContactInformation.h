...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::moveit_msgs::ContactInformation_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ContactInformation_<ContainerAllocator> const> ConstPtr;

}; // struct ContactInformation_

typedef ::moveit_msgs::ContactInformation_<std::allocator<void> > ContactInformation;

typedef std::shared_ptr< ::moveit_msgs::ContactInformation > ContactInformationPtr;
typedef std::shared_ptr< ::moveit_msgs::ContactInformation const> ContactInformationConstPtr;
