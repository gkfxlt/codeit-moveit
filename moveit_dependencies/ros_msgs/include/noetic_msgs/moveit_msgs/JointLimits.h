...
struct JointLimits_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::JointLimits_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::JointLimits_<ContainerAllocator> const> ConstPtr;

}; // struct JointLimits_

typedef ::moveit_msgs::JointLimits_<std::allocator<void> > JointLimits;

typedef std::shared_ptr< ::moveit_msgs::JointLimits > JointLimitsPtr;
typedef std::shared_ptr< ::moveit_msgs::JointLimits const> JointLimitsConstPtr;
