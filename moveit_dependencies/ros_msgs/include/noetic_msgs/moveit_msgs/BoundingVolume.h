...
struct BoundingVolume_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::BoundingVolume_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::BoundingVolume_<ContainerAllocator> const> ConstPtr;

}; // struct BoundingVolume_

typedef ::moveit_msgs::BoundingVolume_<std::allocator<void> > BoundingVolume;

typedef std::shared_ptr< ::moveit_msgs::BoundingVolume > BoundingVolumePtr;
typedef std::shared_ptr< ::moveit_msgs::BoundingVolume const> BoundingVolumeConstPtr;
