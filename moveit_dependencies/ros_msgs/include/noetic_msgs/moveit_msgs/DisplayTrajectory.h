...
struct DisplayTrajectory_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::DisplayTrajectory_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::DisplayTrajectory_<ContainerAllocator> const> ConstPtr;

}; // struct DisplayTrajectory_

typedef ::moveit_msgs::DisplayTrajectory_<std::allocator<void> > DisplayTrajectory;

typedef std::shared_ptr< ::moveit_msgs::DisplayTrajectory > DisplayTrajectoryPtr;
typedef std::shared_ptr< ::moveit_msgs::DisplayTrajectory const> DisplayTrajectoryConstPtr;
