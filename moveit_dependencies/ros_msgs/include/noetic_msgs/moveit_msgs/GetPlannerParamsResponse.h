...
struct GetPlannerParamsResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetPlannerParamsResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetPlannerParamsResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetPlannerParamsResponse_

typedef ::moveit_msgs::GetPlannerParamsResponse_<std::allocator<void> > GetPlannerParamsResponse;

typedef std::shared_ptr< ::moveit_msgs::GetPlannerParamsResponse > GetPlannerParamsResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::GetPlannerParamsResponse const> GetPlannerParamsResponseConstPtr;
