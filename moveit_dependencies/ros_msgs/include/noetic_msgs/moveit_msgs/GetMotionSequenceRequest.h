...
struct GetMotionSequenceRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetMotionSequenceRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetMotionSequenceRequest_

typedef ::moveit_msgs::GetMotionSequenceRequest_<std::allocator<void> > GetMotionSequenceRequest;

typedef std::shared_ptr< ::moveit_msgs::GetMotionSequenceRequest > GetMotionSequenceRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetMotionSequenceRequest const> GetMotionSequenceRequestConstPtr;
