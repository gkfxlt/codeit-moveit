...
struct ListRobotStatesInWarehouseRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ListRobotStatesInWarehouseRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ListRobotStatesInWarehouseRequest_<ContainerAllocator> const> ConstPtr;

}; // struct ListRobotStatesInWarehouseRequest_

typedef ::moveit_msgs::ListRobotStatesInWarehouseRequest_<std::allocator<void> > ListRobotStatesInWarehouseRequest;

typedef std::shared_ptr< ::moveit_msgs::ListRobotStatesInWarehouseRequest > ListRobotStatesInWarehouseRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::ListRobotStatesInWarehouseRequest const> ListRobotStatesInWarehouseRequestConstPtr;
