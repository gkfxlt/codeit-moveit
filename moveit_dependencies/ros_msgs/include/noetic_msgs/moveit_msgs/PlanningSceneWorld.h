...
struct PlanningSceneWorld_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlanningSceneWorld_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlanningSceneWorld_<ContainerAllocator> const> ConstPtr;

}; // struct PlanningSceneWorld_

typedef ::moveit_msgs::PlanningSceneWorld_<std::allocator<void> > PlanningSceneWorld;

typedef std::shared_ptr< ::moveit_msgs::PlanningSceneWorld > PlanningSceneWorldPtr;
typedef std::shared_ptr< ::moveit_msgs::PlanningSceneWorld const> PlanningSceneWorldConstPtr;
