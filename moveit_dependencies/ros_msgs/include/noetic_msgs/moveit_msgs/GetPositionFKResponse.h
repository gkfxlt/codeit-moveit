...
struct GetPositionFKResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetPositionFKResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetPositionFKResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetPositionFKResponse_

typedef ::moveit_msgs::GetPositionFKResponse_<std::allocator<void> > GetPositionFKResponse;

typedef std::shared_ptr< ::moveit_msgs::GetPositionFKResponse > GetPositionFKResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::GetPositionFKResponse const> GetPositionFKResponseConstPtr;
