...
struct SetPlannerParamsRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::SetPlannerParamsRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::SetPlannerParamsRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SetPlannerParamsRequest_

typedef ::moveit_msgs::SetPlannerParamsRequest_<std::allocator<void> > SetPlannerParamsRequest;

typedef std::shared_ptr< ::moveit_msgs::SetPlannerParamsRequest > SetPlannerParamsRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::SetPlannerParamsRequest const> SetPlannerParamsRequestConstPtr;
