...
struct LinkScale_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::LinkScale_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::LinkScale_<ContainerAllocator> const> ConstPtr;

}; // struct LinkScale_

typedef ::moveit_msgs::LinkScale_<std::allocator<void> > LinkScale;

typedef std::shared_ptr< ::moveit_msgs::LinkScale > LinkScalePtr;
typedef std::shared_ptr< ::moveit_msgs::LinkScale const> LinkScaleConstPtr;
