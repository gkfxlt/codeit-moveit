...
struct LoadMapResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::LoadMapResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::LoadMapResponse_<ContainerAllocator> const> ConstPtr;

}; // struct LoadMapResponse_

typedef ::moveit_msgs::LoadMapResponse_<std::allocator<void> > LoadMapResponse;

typedef std::shared_ptr< ::moveit_msgs::LoadMapResponse > LoadMapResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::LoadMapResponse const> LoadMapResponseConstPtr;
