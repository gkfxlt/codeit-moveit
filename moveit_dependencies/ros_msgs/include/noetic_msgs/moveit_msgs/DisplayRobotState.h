...
struct DisplayRobotState_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::DisplayRobotState_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::DisplayRobotState_<ContainerAllocator> const> ConstPtr;

}; // struct DisplayRobotState_

typedef ::moveit_msgs::DisplayRobotState_<std::allocator<void> > DisplayRobotState;

typedef std::shared_ptr< ::moveit_msgs::DisplayRobotState > DisplayRobotStatePtr;
typedef std::shared_ptr< ::moveit_msgs::DisplayRobotState const> DisplayRobotStateConstPtr;
