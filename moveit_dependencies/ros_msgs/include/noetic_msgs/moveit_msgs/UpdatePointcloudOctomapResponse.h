...
struct UpdatePointcloudOctomapResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::UpdatePointcloudOctomapResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::UpdatePointcloudOctomapResponse_<ContainerAllocator> const> ConstPtr;

}; // struct UpdatePointcloudOctomapResponse_

typedef ::moveit_msgs::UpdatePointcloudOctomapResponse_<std::allocator<void> > UpdatePointcloudOctomapResponse;

typedef std::shared_ptr< ::moveit_msgs::UpdatePointcloudOctomapResponse > UpdatePointcloudOctomapResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::UpdatePointcloudOctomapResponse const> UpdatePointcloudOctomapResponseConstPtr;
