...
struct MotionSequenceRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> const> ConstPtr;

}; // struct MotionSequenceRequest_

typedef ::moveit_msgs::MotionSequenceRequest_<std::allocator<void> > MotionSequenceRequest;

typedef std::shared_ptr< ::moveit_msgs::MotionSequenceRequest > MotionSequenceRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::MotionSequenceRequest const> MotionSequenceRequestConstPtr;
