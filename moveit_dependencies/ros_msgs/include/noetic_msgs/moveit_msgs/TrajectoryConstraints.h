...
struct TrajectoryConstraints_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::TrajectoryConstraints_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::TrajectoryConstraints_<ContainerAllocator> const> ConstPtr;

}; // struct TrajectoryConstraints_

typedef ::moveit_msgs::TrajectoryConstraints_<std::allocator<void> > TrajectoryConstraints;

typedef std::shared_ptr< ::moveit_msgs::TrajectoryConstraints > TrajectoryConstraintsPtr;
typedef std::shared_ptr< ::moveit_msgs::TrajectoryConstraints const> TrajectoryConstraintsConstPtr;
