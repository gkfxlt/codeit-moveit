...
struct ExecuteTrajectoryAction_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryAction_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryAction_<ContainerAllocator> const> ConstPtr;

}; // struct ExecuteTrajectoryAction_

typedef ::moveit_msgs::ExecuteTrajectoryAction_<std::allocator<void> > ExecuteTrajectoryAction;

typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryAction > ExecuteTrajectoryActionPtr;
typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryAction const> ExecuteTrajectoryActionConstPtr;
