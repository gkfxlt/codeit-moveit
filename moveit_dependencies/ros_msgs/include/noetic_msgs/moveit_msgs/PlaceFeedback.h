...
struct PlaceFeedback_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::PlaceFeedback_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::PlaceFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceFeedback_

typedef ::moveit_msgs::PlaceFeedback_<std::allocator<void> > PlaceFeedback;

typedef std::shared_ptr< ::moveit_msgs::PlaceFeedback > PlaceFeedbackPtr;
typedef std::shared_ptr< ::moveit_msgs::PlaceFeedback const> PlaceFeedbackConstPtr;
