...
struct GetMotionPlanRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetMotionPlanRequest_

typedef ::moveit_msgs::GetMotionPlanRequest_<std::allocator<void> > GetMotionPlanRequest;

typedef std::shared_ptr< ::moveit_msgs::GetMotionPlanRequest > GetMotionPlanRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetMotionPlanRequest const> GetMotionPlanRequestConstPtr;
