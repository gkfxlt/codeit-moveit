...
struct GraspPlanningResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GraspPlanningResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GraspPlanningResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GraspPlanningResponse_

typedef ::moveit_msgs::GraspPlanningResponse_<std::allocator<void> > GraspPlanningResponse;

typedef std::shared_ptr< ::moveit_msgs::GraspPlanningResponse > GraspPlanningResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::GraspPlanningResponse const> GraspPlanningResponseConstPtr;
