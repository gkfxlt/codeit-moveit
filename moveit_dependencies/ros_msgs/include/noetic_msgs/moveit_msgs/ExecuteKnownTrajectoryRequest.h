...
struct ExecuteKnownTrajectoryRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ExecuteKnownTrajectoryRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ExecuteKnownTrajectoryRequest_<ContainerAllocator> const> ConstPtr;

}; // struct ExecuteKnownTrajectoryRequest_

typedef ::moveit_msgs::ExecuteKnownTrajectoryRequest_<std::allocator<void> > ExecuteKnownTrajectoryRequest;

typedef std::shared_ptr< ::moveit_msgs::ExecuteKnownTrajectoryRequest > ExecuteKnownTrajectoryRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::ExecuteKnownTrajectoryRequest const> ExecuteKnownTrajectoryRequestConstPtr;
