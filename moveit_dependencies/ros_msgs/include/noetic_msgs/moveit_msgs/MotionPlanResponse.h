...
struct MotionPlanResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MotionPlanResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MotionPlanResponse_<ContainerAllocator> const> ConstPtr;

}; // struct MotionPlanResponse_

typedef ::moveit_msgs::MotionPlanResponse_<std::allocator<void> > MotionPlanResponse;

typedef std::shared_ptr< ::moveit_msgs::MotionPlanResponse > MotionPlanResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::MotionPlanResponse const> MotionPlanResponseConstPtr;
