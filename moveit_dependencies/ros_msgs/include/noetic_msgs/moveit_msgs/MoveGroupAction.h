...
struct MoveGroupAction_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::MoveGroupAction_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupAction_

typedef ::moveit_msgs::MoveGroupAction_<std::allocator<void> > MoveGroupAction;

typedef std::shared_ptr< ::moveit_msgs::MoveGroupAction > MoveGroupActionPtr;
typedef std::shared_ptr< ::moveit_msgs::MoveGroupAction const> MoveGroupActionConstPtr;
