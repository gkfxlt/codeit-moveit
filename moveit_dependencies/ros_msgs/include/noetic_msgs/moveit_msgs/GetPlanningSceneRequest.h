...
struct GetPlanningSceneRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetPlanningSceneRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetPlanningSceneRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetPlanningSceneRequest_

typedef ::moveit_msgs::GetPlanningSceneRequest_<std::allocator<void> > GetPlanningSceneRequest;

typedef std::shared_ptr< ::moveit_msgs::GetPlanningSceneRequest > GetPlanningSceneRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetPlanningSceneRequest const> GetPlanningSceneRequestConstPtr;
