...
struct ExecuteTrajectoryGoal_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryGoal_<ContainerAllocator> const> ConstPtr;

}; // struct ExecuteTrajectoryGoal_

typedef ::moveit_msgs::ExecuteTrajectoryGoal_<std::allocator<void> > ExecuteTrajectoryGoal;

typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryGoal > ExecuteTrajectoryGoalPtr;
typedef std::shared_ptr< ::moveit_msgs::ExecuteTrajectoryGoal const> ExecuteTrajectoryGoalConstPtr;
