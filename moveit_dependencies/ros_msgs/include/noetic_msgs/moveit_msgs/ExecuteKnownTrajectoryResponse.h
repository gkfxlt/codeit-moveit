...
struct ExecuteKnownTrajectoryResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ExecuteKnownTrajectoryResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ExecuteKnownTrajectoryResponse_<ContainerAllocator> const> ConstPtr;

}; // struct ExecuteKnownTrajectoryResponse_

typedef ::moveit_msgs::ExecuteKnownTrajectoryResponse_<std::allocator<void> > ExecuteKnownTrajectoryResponse;

typedef std::shared_ptr< ::moveit_msgs::ExecuteKnownTrajectoryResponse > ExecuteKnownTrajectoryResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::ExecuteKnownTrajectoryResponse const> ExecuteKnownTrajectoryResponseConstPtr;
