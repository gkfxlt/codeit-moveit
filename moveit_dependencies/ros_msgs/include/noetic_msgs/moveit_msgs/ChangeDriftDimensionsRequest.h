...
struct ChangeDriftDimensionsRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ChangeDriftDimensionsRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ChangeDriftDimensionsRequest_<ContainerAllocator> const> ConstPtr;

}; // struct ChangeDriftDimensionsRequest_

typedef ::moveit_msgs::ChangeDriftDimensionsRequest_<std::allocator<void> > ChangeDriftDimensionsRequest;

typedef std::shared_ptr< ::moveit_msgs::ChangeDriftDimensionsRequest > ChangeDriftDimensionsRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::ChangeDriftDimensionsRequest const> ChangeDriftDimensionsRequestConstPtr;
