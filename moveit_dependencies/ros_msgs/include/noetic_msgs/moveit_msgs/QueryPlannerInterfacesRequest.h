...
struct QueryPlannerInterfacesRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::QueryPlannerInterfacesRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::QueryPlannerInterfacesRequest_<ContainerAllocator> const> ConstPtr;

}; // struct QueryPlannerInterfacesRequest_

typedef ::moveit_msgs::QueryPlannerInterfacesRequest_<std::allocator<void> > QueryPlannerInterfacesRequest;

typedef std::shared_ptr< ::moveit_msgs::QueryPlannerInterfacesRequest > QueryPlannerInterfacesRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::QueryPlannerInterfacesRequest const> QueryPlannerInterfacesRequestConstPtr;
