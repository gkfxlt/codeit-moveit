...
struct SetPlannerParamsResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::SetPlannerParamsResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::SetPlannerParamsResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SetPlannerParamsResponse_

typedef ::moveit_msgs::SetPlannerParamsResponse_<std::allocator<void> > SetPlannerParamsResponse;

typedef std::shared_ptr< ::moveit_msgs::SetPlannerParamsResponse > SetPlannerParamsResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::SetPlannerParamsResponse const> SetPlannerParamsResponseConstPtr;
