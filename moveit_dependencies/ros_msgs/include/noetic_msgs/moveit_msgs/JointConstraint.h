...
struct JointConstraint_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::JointConstraint_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::JointConstraint_<ContainerAllocator> const> ConstPtr;

}; // struct JointConstraint_

typedef ::moveit_msgs::JointConstraint_<std::allocator<void> > JointConstraint;

typedef std::shared_ptr< ::moveit_msgs::JointConstraint > JointConstraintPtr;
typedef std::shared_ptr< ::moveit_msgs::JointConstraint const> JointConstraintConstPtr;
