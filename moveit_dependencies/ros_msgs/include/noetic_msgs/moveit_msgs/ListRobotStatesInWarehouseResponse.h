...
struct ListRobotStatesInWarehouseResponse_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ListRobotStatesInWarehouseResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ListRobotStatesInWarehouseResponse_<ContainerAllocator> const> ConstPtr;

}; // struct ListRobotStatesInWarehouseResponse_

typedef ::moveit_msgs::ListRobotStatesInWarehouseResponse_<std::allocator<void> > ListRobotStatesInWarehouseResponse;

typedef std::shared_ptr< ::moveit_msgs::ListRobotStatesInWarehouseResponse > ListRobotStatesInWarehouseResponsePtr;
typedef std::shared_ptr< ::moveit_msgs::ListRobotStatesInWarehouseResponse const> ListRobotStatesInWarehouseResponseConstPtr;
