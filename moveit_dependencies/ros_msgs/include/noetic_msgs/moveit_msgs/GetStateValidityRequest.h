...
struct GetStateValidityRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GetStateValidityRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GetStateValidityRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetStateValidityRequest_

typedef ::moveit_msgs::GetStateValidityRequest_<std::allocator<void> > GetStateValidityRequest;

typedef std::shared_ptr< ::moveit_msgs::GetStateValidityRequest > GetStateValidityRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::GetStateValidityRequest const> GetStateValidityRequestConstPtr;
