...
struct DeleteRobotStateFromWarehouseRequest_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::DeleteRobotStateFromWarehouseRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::DeleteRobotStateFromWarehouseRequest_<ContainerAllocator> const> ConstPtr;

}; // struct DeleteRobotStateFromWarehouseRequest_

typedef ::moveit_msgs::DeleteRobotStateFromWarehouseRequest_<std::allocator<void> > DeleteRobotStateFromWarehouseRequest;

typedef std::shared_ptr< ::moveit_msgs::DeleteRobotStateFromWarehouseRequest > DeleteRobotStateFromWarehouseRequestPtr;
typedef std::shared_ptr< ::moveit_msgs::DeleteRobotStateFromWarehouseRequest const> DeleteRobotStateFromWarehouseRequestConstPtr;
