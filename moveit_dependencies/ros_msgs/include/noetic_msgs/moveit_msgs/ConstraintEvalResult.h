...
struct ConstraintEvalResult_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::ConstraintEvalResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::ConstraintEvalResult_<ContainerAllocator> const> ConstPtr;

}; // struct ConstraintEvalResult_

typedef ::moveit_msgs::ConstraintEvalResult_<std::allocator<void> > ConstraintEvalResult;

typedef std::shared_ptr< ::moveit_msgs::ConstraintEvalResult > ConstraintEvalResultPtr;
typedef std::shared_ptr< ::moveit_msgs::ConstraintEvalResult const> ConstraintEvalResultConstPtr;
