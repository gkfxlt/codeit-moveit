...
struct GripperTranslation_
{
  ...
  typedef std::shared_ptr< ::moveit_msgs::GripperTranslation_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::moveit_msgs::GripperTranslation_<ContainerAllocator> const> ConstPtr;

}; // struct GripperTranslation_

typedef ::moveit_msgs::GripperTranslation_<std::allocator<void> > GripperTranslation;

typedef std::shared_ptr< ::moveit_msgs::GripperTranslation > GripperTranslationPtr;
typedef std::shared_ptr< ::moveit_msgs::GripperTranslation const> GripperTranslationConstPtr;
