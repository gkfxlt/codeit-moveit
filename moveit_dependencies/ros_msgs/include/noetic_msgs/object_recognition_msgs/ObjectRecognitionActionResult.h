...
struct ObjectRecognitionActionResult_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionActionResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionActionResult_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectRecognitionActionResult_

typedef ::object_recognition_msgs::ObjectRecognitionActionResult_<std::allocator<void> > ObjectRecognitionActionResult;

typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionActionResult > ObjectRecognitionActionResultPtr;
typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionActionResult const> ObjectRecognitionActionResultConstPtr;
