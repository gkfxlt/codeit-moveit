...
struct GetObjectInformationResponse_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::GetObjectInformationResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::GetObjectInformationResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetObjectInformationResponse_

typedef ::object_recognition_msgs::GetObjectInformationResponse_<std::allocator<void> > GetObjectInformationResponse;

typedef std::shared_ptr< ::object_recognition_msgs::GetObjectInformationResponse > GetObjectInformationResponsePtr;
typedef std::shared_ptr< ::object_recognition_msgs::GetObjectInformationResponse const> GetObjectInformationResponseConstPtr;
