...
struct ObjectRecognitionAction_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionAction_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionAction_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectRecognitionAction_

typedef ::object_recognition_msgs::ObjectRecognitionAction_<std::allocator<void> > ObjectRecognitionAction;

typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionAction > ObjectRecognitionActionPtr;
typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionAction const> ObjectRecognitionActionConstPtr;
