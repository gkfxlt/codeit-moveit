...
struct Table_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::Table_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::Table_<ContainerAllocator> const> ConstPtr;

}; // struct Table_

typedef ::object_recognition_msgs::Table_<std::allocator<void> > Table;

typedef std::shared_ptr< ::object_recognition_msgs::Table > TablePtr;
typedef std::shared_ptr< ::object_recognition_msgs::Table const> TableConstPtr;
