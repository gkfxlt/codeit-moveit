...
struct ObjectRecognitionGoal_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectRecognitionGoal_

typedef ::object_recognition_msgs::ObjectRecognitionGoal_<std::allocator<void> > ObjectRecognitionGoal;

typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionGoal > ObjectRecognitionGoalPtr;
typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionGoal const> ObjectRecognitionGoalConstPtr;
