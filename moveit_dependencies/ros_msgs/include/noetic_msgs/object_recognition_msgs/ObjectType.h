...
struct ObjectType_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectType_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectType_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectType_

typedef ::object_recognition_msgs::ObjectType_<std::allocator<void> > ObjectType;

typedef std::shared_ptr< ::object_recognition_msgs::ObjectType > ObjectTypePtr;
typedef std::shared_ptr< ::object_recognition_msgs::ObjectType const> ObjectTypeConstPtr;
