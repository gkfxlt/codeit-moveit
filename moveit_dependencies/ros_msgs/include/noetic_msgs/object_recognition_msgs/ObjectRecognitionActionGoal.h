...
struct ObjectRecognitionActionGoal_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectRecognitionActionGoal_

typedef ::object_recognition_msgs::ObjectRecognitionActionGoal_<std::allocator<void> > ObjectRecognitionActionGoal;

typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionActionGoal > ObjectRecognitionActionGoalPtr;
typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionActionGoal const> ObjectRecognitionActionGoalConstPtr;
