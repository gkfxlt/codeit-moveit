...
struct ObjectRecognitionFeedback_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionFeedback_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectRecognitionFeedback_

typedef ::object_recognition_msgs::ObjectRecognitionFeedback_<std::allocator<void> > ObjectRecognitionFeedback;

typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionFeedback > ObjectRecognitionFeedbackPtr;
typedef std::shared_ptr< ::object_recognition_msgs::ObjectRecognitionFeedback const> ObjectRecognitionFeedbackConstPtr;
