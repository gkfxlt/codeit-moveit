...
struct TableArray_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::TableArray_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::TableArray_<ContainerAllocator> const> ConstPtr;

}; // struct TableArray_

typedef ::object_recognition_msgs::TableArray_<std::allocator<void> > TableArray;

typedef std::shared_ptr< ::object_recognition_msgs::TableArray > TableArrayPtr;
typedef std::shared_ptr< ::object_recognition_msgs::TableArray const> TableArrayConstPtr;
