...
struct GetObjectInformationRequest_
{
  ...
  typedef std::shared_ptr< ::object_recognition_msgs::GetObjectInformationRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::object_recognition_msgs::GetObjectInformationRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetObjectInformationRequest_

typedef ::object_recognition_msgs::GetObjectInformationRequest_<std::allocator<void> > GetObjectInformationRequest;

typedef std::shared_ptr< ::object_recognition_msgs::GetObjectInformationRequest > GetObjectInformationRequestPtr;
typedef std::shared_ptr< ::object_recognition_msgs::GetObjectInformationRequest const> GetObjectInformationRequestConstPtr;
