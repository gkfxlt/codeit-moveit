...
//*************************创建控制器***********************//////
auto createVrepControllerPr2() -> std::unique_ptr<codeit::controller::Controller>;
...
auto createComController(const NumList* num = nullptr, const std::string& name = "com_controller",
                         const core::SerialPort::ComOptions& options = core::SerialPort::defaultComOptions,
                         Size pack_size = 0, Size nrt_id = 0) -> std::unique_ptr<codeit::controller::NrtController>;
auto createSocketController(const NumList* num = nullptr, std::string name = "socket_controller", std::string ip = "",
                            std::string port = "",
                            controller::SocketMaster::TYPE type = controller::SocketMaster::TYPE::TCP, Size nrt_id = 0)
    -> std::unique_ptr<codeit::controller::NrtController>;
