// Generated by gencpp from file _sensor_msgs/LaserScan.msg
// DO NOT EDIT!


#ifndef _SENSOR_MSGS_MESSAGE_LASERSCAN_H
#define _SENSOR_MSGS_MESSAGE_LASERSCAN_H
...
struct LaserScan_
{
  ...
  typedef std::shared_ptr< ::_sensor_msgs::LaserScan_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_sensor_msgs::LaserScan_<ContainerAllocator> const> ConstPtr;

}; // struct LaserScan_

typedef ::_sensor_msgs::LaserScan_<std::allocator<void> > LaserScan;

typedef std::shared_ptr< ::_sensor_msgs::LaserScan > LaserScanPtr;
typedef std::shared_ptr< ::_sensor_msgs::LaserScan const> LaserScanConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_sensor_msgs::LaserScan_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_sensor_msgs::LaserScan_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_sensor_msgs::LaserScan_<ContainerAllocator1> & lhs, const ::_sensor_msgs::LaserScan_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_sensor_msgs::LaserScan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_sensor_msgs::LaserScan_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_sensor_msgs::LaserScan_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_sensor_msgs::LaserScan_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_sensor_msgs::LaserScan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_sensor_msgs::LaserScan_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_sensor_msgs::LaserScan_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_sensor_msgs::LaserScan_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x90c7ef2dc6895d81ULL;
  static const uint64_t static_value2 = 0x024acba2ac42f369ULL;
};

template<class ContainerAllocator>
struct DataType< ::_sensor_msgs::LaserScan_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_sensor_msgs/LaserScan";
  }
...
template<class ContainerAllocator>
struct Definition< ::_sensor_msgs::LaserScan_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_sensor_msgs::LaserScan_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_sensor_msgs::LaserScan_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_sensor_msgs::LaserScan_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
