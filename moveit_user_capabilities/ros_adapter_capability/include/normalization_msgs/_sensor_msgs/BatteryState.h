// Generated by gencpp from file _sensor_msgs/BatteryState.msg
// DO NOT EDIT!


#ifndef _SENSOR_MSGS_MESSAGE_BATTERYSTATE_H
#define _SENSOR_MSGS_MESSAGE_BATTERYSTATE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::_sensor_msgs::BatteryState_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_sensor_msgs::BatteryState_<ContainerAllocator> const> ConstPtr;

}; // struct BatteryState_

typedef ::_sensor_msgs::BatteryState_<std::allocator<void> > BatteryState;

typedef std::shared_ptr< ::_sensor_msgs::BatteryState > BatteryStatePtr;
typedef std::shared_ptr< ::_sensor_msgs::BatteryState const> BatteryStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_sensor_msgs::BatteryState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_sensor_msgs::BatteryState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_sensor_msgs::BatteryState_<ContainerAllocator1> & lhs, const ::_sensor_msgs::BatteryState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_sensor_msgs::BatteryState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_sensor_msgs::BatteryState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_sensor_msgs::BatteryState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_sensor_msgs::BatteryState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_sensor_msgs::BatteryState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_sensor_msgs::BatteryState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_sensor_msgs::BatteryState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_sensor_msgs::BatteryState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4ddae7f048e32fdaULL;
  static const uint64_t static_value2 = 0x22cac764685e3974ULL;
};

template<class ContainerAllocator>
struct DataType< ::_sensor_msgs::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_sensor_msgs/BatteryState";
  }
...
template<class ContainerAllocator>
struct Definition< ::_sensor_msgs::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_sensor_msgs::BatteryState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_sensor_msgs::BatteryState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_sensor_msgs::BatteryState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
