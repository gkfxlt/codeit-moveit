// Generated by gencpp from file _visualization_msgs/Marker.msg
// DO NOT EDIT!


#ifndef _VISUALIZATION_MSGS_MESSAGE_MARKER_H
#define _VISUALIZATION_MSGS_MESSAGE_MARKER_H
...
struct Marker_
{
  ...
  _pose_type pose;
   ...
   typedef  ::_geometry_msgs::Vector3_<ContainerAllocator>  _scale_type;
  _scale_type scale;

   typedef  ::_std_msgs::ColorRGBA_<ContainerAllocator>  _color_type;
  _color_type color;
  ...
  _points_type points;
   ...
   typedef std::vector< ::_std_msgs::ColorRGBA_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::_std_msgs::ColorRGBA_<ContainerAllocator> >::other >  _colors_type;
  _colors_type colors;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::_visualization_msgs::Marker_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_visualization_msgs::Marker_<ContainerAllocator> const> ConstPtr;

}; // struct Marker_

typedef ::_visualization_msgs::Marker_<std::allocator<void> > Marker;

typedef std::shared_ptr< ::_visualization_msgs::Marker > MarkerPtr;
typedef std::shared_ptr< ::_visualization_msgs::Marker const> MarkerConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_visualization_msgs::Marker_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_visualization_msgs::Marker_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_visualization_msgs::Marker_<ContainerAllocator1> & lhs, const ::_visualization_msgs::Marker_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_visualization_msgs::Marker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_visualization_msgs::Marker_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_visualization_msgs::Marker_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_visualization_msgs::Marker_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_visualization_msgs::Marker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_visualization_msgs::Marker_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_visualization_msgs::Marker_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_visualization_msgs::Marker_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4048c9de2a16f4aeULL;
  static const uint64_t static_value2 = 0x8e0538085ebf1b97ULL;
};

template<class ContainerAllocator>
struct DataType< ::_visualization_msgs::Marker_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_visualization_msgs/Marker";
  }
...
template<class ContainerAllocator>
struct Definition< ::_visualization_msgs::Marker_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_visualization_msgs::Marker_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_visualization_msgs::Marker_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_visualization_msgs::Marker_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "scale: ";
    s << std::endl;
    Printer< ::_geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.scale);
    s << indent << "color: ";
    s << std::endl;
    Printer< ::_std_msgs::ColorRGBA_<ContainerAllocator> >::stream(s, indent + "  ", v.color);
    s << indent << "lifetime: ";
    ...
    for (size_t i = 0; i < v.colors.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::_std_msgs::ColorRGBA_<ContainerAllocator> >::stream(s, indent + "    ", v.colors[i]);
    }
    s << indent << "text: ";
