// Generated by gencpp from file _moveit_msgs/MoveGroupSequenceGoal.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEGOAL_H
#define _MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEGOAL_H
...
#include <_moveit_msgs/MotionSequenceRequest.h>
#include <_moveit_msgs/PlanningOptions.h>
...
struct MoveGroupSequenceGoal_
{
  ...
  (void)_alloc;
   ...
   typedef  ::_moveit_msgs::MotionSequenceRequest_<ContainerAllocator>  _request_type;
  _request_type request;

   typedef  ::_moveit_msgs::PlanningOptions_<ContainerAllocator>  _planning_options_type;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupSequenceGoal_

typedef ::_moveit_msgs::MoveGroupSequenceGoal_<std::allocator<void> > MoveGroupSequenceGoal;

typedef std::shared_ptr< ::_moveit_msgs::MoveGroupSequenceGoal > MoveGroupSequenceGoalPtr;
typedef std::shared_ptr< ::_moveit_msgs::MoveGroupSequenceGoal const> MoveGroupSequenceGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator1> & lhs, const ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xffb5d660ea6e0aa4ULL;
  static const uint64_t static_value2 = 0x569898d2d0b1d51fULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/MoveGroupSequenceGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator>& v)
  {
    s << indent << "request: ";
    s << std::endl;
    Printer< ::_moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >::stream(s, indent + "  ", v.request);
    s << indent << "planning_options: ";
    s << std::endl;
    Printer< ::_moveit_msgs::PlanningOptions_<ContainerAllocator> >::stream(s, indent + "  ", v.planning_options);
  }
};
