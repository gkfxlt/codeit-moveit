// Generated by gencpp from file _moveit_msgs/GetMotionPlanRequest.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_GETMOTIONPLANREQUEST_H
#define _MOVEIT_MSGS_MESSAGE_GETMOTIONPLANREQUEST_H
...
struct GetMotionPlanRequest_
{
  ...
  (void)_alloc;
   ...
   typedef  ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator>  _motion_plan_request_type;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GetMotionPlanRequest_

typedef ::_moveit_msgs::GetMotionPlanRequest_<std::allocator<void> > GetMotionPlanRequest;

typedef std::shared_ptr< ::_moveit_msgs::GetMotionPlanRequest > GetMotionPlanRequestPtr;
typedef std::shared_ptr< ::_moveit_msgs::GetMotionPlanRequest const> GetMotionPlanRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator1> & lhs, const ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5459d2db10f706c7ULL;
  static const uint64_t static_value2 = 0xe69e5485e0b58672ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/GetMotionPlanRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::GetMotionPlanRequest_<ContainerAllocator>& v)
  {
    s << indent << "motion_plan_request: ";
    s << std::endl;
    Printer< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >::stream(s, indent + "  ", v.motion_plan_request);
  }
};
