// Generated by gencpp from file _moveit_msgs/PlaceGoal.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_PLACEGOAL_H
#define _MOVEIT_MSGS_MESSAGE_PLACEGOAL_H
...
#include <_moveit_msgs/PlaceLocation.h>
...
struct PlaceGoal_
{
  ...
  _attached_object_name_type attached_object_name;
   ...
   typedef std::vector< ::_moveit_msgs::PlaceLocation_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::_moveit_msgs::PlaceLocation_<ContainerAllocator> >::other >  _place_locations_type;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceGoal_

typedef ::_moveit_msgs::PlaceGoal_<std::allocator<void> > PlaceGoal;

typedef std::shared_ptr< ::_moveit_msgs::PlaceGoal > PlaceGoalPtr;
typedef std::shared_ptr< ::_moveit_msgs::PlaceGoal const> PlaceGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::PlaceGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::PlaceGoal_<ContainerAllocator1> & lhs, const ::_moveit_msgs::PlaceGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::PlaceGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb5ff24625cebec44ULL;
  static const uint64_t static_value2 = 0x0c18cd2e1d833764ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/PlaceGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::PlaceGoal_<ContainerAllocator>& v)
  {
    s << indent << "group_name: ";
    ...
    for (size_t i = 0; i < v.place_locations.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::_moveit_msgs::PlaceLocation_<ContainerAllocator> >::stream(s, indent + "    ", v.place_locations[i]);
    }
    s << indent << "place_eef: ";
