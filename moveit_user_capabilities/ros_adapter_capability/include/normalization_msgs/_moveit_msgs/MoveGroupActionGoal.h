// Generated by gencpp from file _moveit_msgs/MoveGroupActionGoal.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_MOVEGROUPACTIONGOAL_H
#define _MOVEIT_MSGS_MESSAGE_MOVEGROUPACTIONGOAL_H
...
#include <_moveit_msgs/MoveGroupGoal.h>
...
struct MoveGroupActionGoal_
{
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupActionGoal_

typedef ::_moveit_msgs::MoveGroupActionGoal_<std::allocator<void> > MoveGroupActionGoal;

typedef std::shared_ptr< ::_moveit_msgs::MoveGroupActionGoal > MoveGroupActionGoalPtr;
typedef std::shared_ptr< ::_moveit_msgs::MoveGroupActionGoal const> MoveGroupActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator1> & lhs, const ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x152e336e337dce7cULL;
  static const uint64_t static_value2 = 0xbe639f1bd9c65defULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/MoveGroupActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::MoveGroupActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
