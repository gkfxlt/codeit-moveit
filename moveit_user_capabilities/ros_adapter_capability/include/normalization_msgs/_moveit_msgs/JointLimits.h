// Generated by gencpp from file _moveit_msgs/JointLimits.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_JOINTLIMITS_H
#define _MOVEIT_MSGS_MESSAGE_JOINTLIMITS_H
...
struct JointLimits_
{
  ...
  typedef std::shared_ptr< ::_moveit_msgs::JointLimits_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::JointLimits_<ContainerAllocator> const> ConstPtr;

}; // struct JointLimits_

typedef ::_moveit_msgs::JointLimits_<std::allocator<void> > JointLimits;

typedef std::shared_ptr< ::_moveit_msgs::JointLimits > JointLimitsPtr;
typedef std::shared_ptr< ::_moveit_msgs::JointLimits const> JointLimitsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::JointLimits_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::JointLimits_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::JointLimits_<ContainerAllocator1> & lhs, const ::_moveit_msgs::JointLimits_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::JointLimits_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::JointLimits_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::JointLimits_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::JointLimits_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::JointLimits_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::JointLimits_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::JointLimits_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::JointLimits_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8ca618c7329ea461ULL;
  static const uint64_t static_value2 = 0x42cbc864a2efe856ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::JointLimits_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/JointLimits";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::JointLimits_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::JointLimits_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::JointLimits_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::JointLimits_<ContainerAllocator>& v)
  {
    s << indent << "joint_name: ";
