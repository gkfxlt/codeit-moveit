// Generated by gencpp from file _moveit_msgs/OrientationConstraint.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_ORIENTATIONCONSTRAINT_H
#define _MOVEIT_MSGS_MESSAGE_ORIENTATIONCONSTRAINT_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> const> ConstPtr;

}; // struct OrientationConstraint_

typedef ::_moveit_msgs::OrientationConstraint_<std::allocator<void> > OrientationConstraint;

typedef std::shared_ptr< ::_moveit_msgs::OrientationConstraint > OrientationConstraintPtr;
typedef std::shared_ptr< ::_moveit_msgs::OrientationConstraint const> OrientationConstraintConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::OrientationConstraint_<ContainerAllocator1> & lhs, const ::_moveit_msgs::OrientationConstraint_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::OrientationConstraint_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x183479d9281e5b4fULL;
  static const uint64_t static_value2 = 0x23dc584f711d8a64ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/OrientationConstraint";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::OrientationConstraint_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::OrientationConstraint_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
