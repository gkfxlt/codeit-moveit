// Generated by gencpp from file _moveit_msgs/ContactInformation.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_CONTACTINFORMATION_H
#define _MOVEIT_MSGS_MESSAGE_CONTACTINFORMATION_H
...
struct ContactInformation_
{
  ...
  _position_type position;
   ...
   typedef  ::_geometry_msgs::Vector3_<ContainerAllocator>  _normal_type;
  _normal_type normal;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::_moveit_msgs::ContactInformation_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::ContactInformation_<ContainerAllocator> const> ConstPtr;

}; // struct ContactInformation_

typedef ::_moveit_msgs::ContactInformation_<std::allocator<void> > ContactInformation;

typedef std::shared_ptr< ::_moveit_msgs::ContactInformation > ContactInformationPtr;
typedef std::shared_ptr< ::_moveit_msgs::ContactInformation const> ContactInformationConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::ContactInformation_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::ContactInformation_<ContainerAllocator1> & lhs, const ::_moveit_msgs::ContactInformation_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::ContactInformation_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::ContactInformation_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::ContactInformation_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::ContactInformation_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x116228ca08b0c286ULL;
  static const uint64_t static_value2 = 0xec5ca32a50fdc17bULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/ContactInformation";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::ContactInformation_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::ContactInformation_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "normal: ";
    s << std::endl;
    Printer< ::_geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.normal);
    s << indent << "depth: ";
