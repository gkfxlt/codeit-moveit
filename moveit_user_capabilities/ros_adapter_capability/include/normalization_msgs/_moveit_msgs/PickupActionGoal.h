// Generated by gencpp from file _moveit_msgs/PickupActionGoal.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_PICKUPACTIONGOAL_H
#define _MOVEIT_MSGS_MESSAGE_PICKUPACTIONGOAL_H
...
#include <_moveit_msgs/PickupGoal.h>
...
struct PickupActionGoal_
{
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::_moveit_msgs::PickupGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PickupActionGoal_

typedef ::_moveit_msgs::PickupActionGoal_<std::allocator<void> > PickupActionGoal;

typedef std::shared_ptr< ::_moveit_msgs::PickupActionGoal > PickupActionGoalPtr;
typedef std::shared_ptr< ::_moveit_msgs::PickupActionGoal const> PickupActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::PickupActionGoal_<ContainerAllocator1> & lhs, const ::_moveit_msgs::PickupActionGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::PickupActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x83bb430d120a16faULL;
  static const uint64_t static_value2 = 0xdf2ea3aad239f1d1ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/PickupActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::PickupActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::PickupActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::_moveit_msgs::PickupGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
