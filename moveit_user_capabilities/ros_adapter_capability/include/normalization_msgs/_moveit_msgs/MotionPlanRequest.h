// Generated by gencpp from file _moveit_msgs/MotionPlanRequest.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_MOTIONPLANREQUEST_H
#define _MOVEIT_MSGS_MESSAGE_MOTIONPLANREQUEST_H
...
#include <_moveit_msgs/WorkspaceParameters.h>
#include <_moveit_msgs/RobotState.h>
#include <_moveit_msgs/Constraints.h>
#include <_moveit_msgs/Constraints.h>
#include <_moveit_msgs/TrajectoryConstraints.h>
#include <_moveit_msgs/GenericTrajectory.h>
...
struct MotionPlanRequest_
{
  ...
  (void)_alloc;
   ...
   typedef  ::_moveit_msgs::WorkspaceParameters_<ContainerAllocator>  _workspace_parameters_type;
  _workspace_parameters_type workspace_parameters;

   typedef  ::_moveit_msgs::RobotState_<ContainerAllocator>  _start_state_type;
  _start_state_type start_state;

   typedef std::vector< ::_moveit_msgs::Constraints_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::_moveit_msgs::Constraints_<ContainerAllocator> >::other >  _goal_constraints_type;
  _goal_constraints_type goal_constraints;

   typedef  ::_moveit_msgs::Constraints_<ContainerAllocator>  _path_constraints_type;
  _path_constraints_type path_constraints;

   typedef  ::_moveit_msgs::TrajectoryConstraints_<ContainerAllocator>  _trajectory_constraints_type;
  _trajectory_constraints_type trajectory_constraints;

   typedef std::vector< ::_moveit_msgs::GenericTrajectory_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::_moveit_msgs::GenericTrajectory_<ContainerAllocator> >::other >  _reference_trajectories_type;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> const> ConstPtr;

}; // struct MotionPlanRequest_

typedef ::_moveit_msgs::MotionPlanRequest_<std::allocator<void> > MotionPlanRequest;

typedef std::shared_ptr< ::_moveit_msgs::MotionPlanRequest > MotionPlanRequestPtr;
typedef std::shared_ptr< ::_moveit_msgs::MotionPlanRequest const> MotionPlanRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator1> & lhs, const ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9544d5f3b9cf69a0ULL;
  static const uint64_t static_value2 = 0xe1e7f8c75d87f54bULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/MotionPlanRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator>& v)
  {
    s << indent << "workspace_parameters: ";
    s << std::endl;
    Printer< ::_moveit_msgs::WorkspaceParameters_<ContainerAllocator> >::stream(s, indent + "  ", v.workspace_parameters);
    s << indent << "start_state: ";
    s << std::endl;
    Printer< ::_moveit_msgs::RobotState_<ContainerAllocator> >::stream(s, indent + "  ", v.start_state);
    ...
    for (size_t i = 0; i < v.goal_constraints.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::_moveit_msgs::Constraints_<ContainerAllocator> >::stream(s, indent + "    ", v.goal_constraints[i]);
    }
    s << indent << "path_constraints: ";
    s << std::endl;
    Printer< ::_moveit_msgs::Constraints_<ContainerAllocator> >::stream(s, indent + "  ", v.path_constraints);
    s << indent << "trajectory_constraints: ";
    s << std::endl;
    Printer< ::_moveit_msgs::TrajectoryConstraints_<ContainerAllocator> >::stream(s, indent + "  ", v.trajectory_constraints);
    ...
    for (size_t i = 0; i < v.reference_trajectories.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::_moveit_msgs::GenericTrajectory_<ContainerAllocator> >::stream(s, indent + "    ", v.reference_trajectories[i]);
    }
