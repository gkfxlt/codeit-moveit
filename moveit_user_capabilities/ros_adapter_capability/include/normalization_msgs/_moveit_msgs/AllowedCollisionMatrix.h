// Generated by gencpp from file _moveit_msgs/AllowedCollisionMatrix.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_ALLOWEDCOLLISIONMATRIX_H
#define _MOVEIT_MSGS_MESSAGE_ALLOWEDCOLLISIONMATRIX_H
...
#include <_moveit_msgs/AllowedCollisionEntry.h>
...
struct AllowedCollisionMatrix_
{
  ...
  _entry_names_type entry_names;
   ...
   typedef std::vector< ::_moveit_msgs::AllowedCollisionEntry_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::_moveit_msgs::AllowedCollisionEntry_<ContainerAllocator> >::other >  _entry_values_type;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> const> ConstPtr;

}; // struct AllowedCollisionMatrix_

typedef ::_moveit_msgs::AllowedCollisionMatrix_<std::allocator<void> > AllowedCollisionMatrix;

typedef std::shared_ptr< ::_moveit_msgs::AllowedCollisionMatrix > AllowedCollisionMatrixPtr;
typedef std::shared_ptr< ::_moveit_msgs::AllowedCollisionMatrix const> AllowedCollisionMatrixConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator1> & lhs, const ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xaedce13587eef0d7ULL;
  static const uint64_t static_value2 = 0x9165a075659c1879ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/AllowedCollisionMatrix";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::AllowedCollisionMatrix_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.entry_values.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::_moveit_msgs::AllowedCollisionEntry_<ContainerAllocator> >::stream(s, indent + "    ", v.entry_values[i]);
    }
