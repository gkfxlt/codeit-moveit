// Generated by gencpp from file _moveit_msgs/PlaceActionGoal.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_PLACEACTIONGOAL_H
#define _MOVEIT_MSGS_MESSAGE_PLACEACTIONGOAL_H
...
#include <_moveit_msgs/PlaceGoal.h>
...
struct PlaceActionGoal_
{
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::_moveit_msgs::PlaceGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PlaceActionGoal_

typedef ::_moveit_msgs::PlaceActionGoal_<std::allocator<void> > PlaceActionGoal;

typedef std::shared_ptr< ::_moveit_msgs::PlaceActionGoal > PlaceActionGoalPtr;
typedef std::shared_ptr< ::_moveit_msgs::PlaceActionGoal const> PlaceActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator1> & lhs, const ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3f3419319ea8d2afULL;
  static const uint64_t static_value2 = 0x4e18a600962d0cf5ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/PlaceActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::PlaceActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::_moveit_msgs::PlaceGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
