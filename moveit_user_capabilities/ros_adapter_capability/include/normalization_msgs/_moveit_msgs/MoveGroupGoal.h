// Generated by gencpp from file _moveit_msgs/MoveGroupGoal.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_MOVEGROUPGOAL_H
#define _MOVEIT_MSGS_MESSAGE_MOVEGROUPGOAL_H
...
struct MoveGroupGoal_
{
  ...
  (void)_alloc;
   ...
   typedef  ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator>  _request_type;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupGoal_

typedef ::_moveit_msgs::MoveGroupGoal_<std::allocator<void> > MoveGroupGoal;

typedef std::shared_ptr< ::_moveit_msgs::MoveGroupGoal > MoveGroupGoalPtr;
typedef std::shared_ptr< ::_moveit_msgs::MoveGroupGoal const> MoveGroupGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator1> & lhs, const ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x995f602257ab6c41ULL;
  static const uint64_t static_value2 = 0xdf8948daf6a3ed57ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/MoveGroupGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::MoveGroupGoal_<ContainerAllocator>& v)
  {
    s << indent << "request: ";
    s << std::endl;
    Printer< ::_moveit_msgs::MotionPlanRequest_<ContainerAllocator> >::stream(s, indent + "  ", v.request);
