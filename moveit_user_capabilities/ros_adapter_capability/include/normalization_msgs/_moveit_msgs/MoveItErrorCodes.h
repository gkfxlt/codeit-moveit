// Generated by gencpp from file _moveit_msgs/MoveItErrorCodes.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_MOVEITERRORCODES_H
#define _MOVEIT_MSGS_MESSAGE_MOVEITERRORCODES_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> const> ConstPtr;

}; // struct MoveItErrorCodes_

typedef ::_moveit_msgs::MoveItErrorCodes_<std::allocator<void> > MoveItErrorCodes;

typedef std::shared_ptr< ::_moveit_msgs::MoveItErrorCodes > MoveItErrorCodesPtr;
typedef std::shared_ptr< ::_moveit_msgs::MoveItErrorCodes const> MoveItErrorCodesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator1> & lhs, const ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x35a153d4489afb90ULL;
  static const uint64_t static_value2 = 0xa182bbf874ecc0f3ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/MoveItErrorCodes";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 val\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::MoveItErrorCodes_<ContainerAllocator>& v)
  {
    s << indent << "val: ";
