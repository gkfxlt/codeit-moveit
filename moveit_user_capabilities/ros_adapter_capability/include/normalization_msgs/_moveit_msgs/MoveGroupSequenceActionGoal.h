// Generated by gencpp from file _moveit_msgs/MoveGroupSequenceActionGoal.msg
// DO NOT EDIT!


#ifndef _MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEACTIONGOAL_H
#define _MOVEIT_MSGS_MESSAGE_MOVEGROUPSEQUENCEACTIONGOAL_H
...
#include <_moveit_msgs/MoveGroupSequenceGoal.h>
...
struct MoveGroupSequenceActionGoal_
{
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef std::shared_ptr< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveGroupSequenceActionGoal_

typedef ::_moveit_msgs::MoveGroupSequenceActionGoal_<std::allocator<void> > MoveGroupSequenceActionGoal;

typedef std::shared_ptr< ::_moveit_msgs::MoveGroupSequenceActionGoal > MoveGroupSequenceActionGoalPtr;
typedef std::shared_ptr< ::_moveit_msgs::MoveGroupSequenceActionGoal const> MoveGroupSequenceActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator1> & lhs, const ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe8092a3ff0d4ffe7ULL;
  static const uint64_t static_value2 = 0x720dd24304ae29d9ULL;
};

template<class ContainerAllocator>
struct DataType< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "_moveit_msgs/MoveGroupSequenceActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::_moveit_msgs::MoveGroupSequenceActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::_moveit_msgs::MoveGroupSequenceGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
