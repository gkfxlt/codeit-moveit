#ifndef CODEIT_DYNAMIC_MODEL_COORDINATE_H_
#define CODEIT_DYNAMIC_MODEL_COORDINATE_H_
...
namespace codeit::model
{
	...
	public:
		...
		CODEIT_REGISTER_TYPE(Coordinate);
		CODEIT_DEFINE_BIG_FOUR(Coordinate);
	};
	...
	public:
		...
		//**新增
		auto inertialVec()const noexcept->const double10&;
		auto setInertial(const double* inertia_vec) noexcept->void;

		virtual ~Marker();
		explicit Marker(const std::string &name = "marker", const double *prt_pm = nullptr, bool active = true, const double *inertia_vec=nullptr);
		CODEIT_REGISTER_TYPE(Marker);
		CODEIT_DECLARE_BIG_FOUR(Marker);
	...
	public:
		...
		auto markerPool() noexcept->core::ObjectPool<Marker, Element>&;
		auto markerPool()const noexcept->const core::ObjectPool<Marker, Element>&;
		auto geometryPool() noexcept->core::ObjectPool<Geometry, Element>&;
		auto geometryPool()const noexcept->const core::ObjectPool<Geometry, Element>&;
		...
		////******新增*****/////
		auto setZeroPm(const double *pm) noexcept->void;
		auto zeroPm() const noexcept->const double4x4&;
		virtual ~Part();
		...
		CODEIT_REGISTER_TYPE(Part);
		CODEIT_DECLARE_BIG_FOUR(Part);
	...
	public:
		...
		CODEIT_REGISTER_TYPE(Geometry);
		CODEIT_DEFINE_BIG_FOUR(Geometry);
	};
	...
	public:
		...
		CODEIT_REGISTER_TYPE(ParasolidGeometry);
		CODEIT_DECLARE_BIG_FOUR(ParasolidGeometry);
	...
	public:
		...
		CODEIT_REGISTER_TYPE(FileGeometry);
		CODEIT_DECLARE_BIG_FOUR(FileGeometry);
	...
	public:
		...
		CODEIT_REGISTER_TYPE(ShellGeometry);
		CODEIT_DECLARE_BIG_FOUR(ShellGeometry);
