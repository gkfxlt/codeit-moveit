#ifndef CODEIT_DYNAMIC_QUADRUPED_H_
#define CODEIT_DYNAMIC_QUADRUPED_H_
...
namespace codeit::model
{
	...
	auto createModelQuadruped(const QuadrupedParam& param, std::string name = "model")->std::unique_ptr<codeit::model::Model>;
