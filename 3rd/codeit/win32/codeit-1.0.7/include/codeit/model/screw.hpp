#ifndef CODEIT_DYNAMIC_SCREW_H_
#define CODEIT_DYNAMIC_SCREW_H_
...
namespace codeit::model
{
	...
	///
	///
	auto s_sov_ab_arbitrary(const double* pp0, const double* pp, double* alpha, double* beta, const char* order = "321")noexcept->int;
